...
export default function NavbarComponent() {
    ...
    return (
        <Navbar className="mt-1 mx-2 p-2 border-b">
            ...
            { user != null && (
                <NavItem>
                    <NavLink href="https://localhost:5000/authorise/slack" style={{alignItems: "center", color: "#fff", backgroundColor: "#4A154B", border: 0, borderRadius: "48px", display: "inline-flex", fontFamily: "Lato, sans-serif", fontSize: "16px", fontWeight: 600, height: "48px", justifyContent: "center", textDecoration: "none", width: "190px"}}>
